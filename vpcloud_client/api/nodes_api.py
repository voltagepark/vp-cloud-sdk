...
class NodesApi:
    ...
    def get_fleet_node_details(
        ...
        _param = self._get_fleet_node_details_serialize(
            fleet_id=fleet_id,
            node_id=node_id,
    ...
    def _get_fleet_node_details_serialize(
        self,
        fleet_id,
        node_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/fleets/{fleetId}/nodes/{nodeId}/details',
    ...
    def get_node_power_state(
        ...
        _param = self._get_node_power_state_serialize(
            fleet_id=fleet_id,
            node_id=node_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_node_power_state_with_http_info(
        self,
        fleet_id: Annotated[UUID, Field(description="Fleet identifier")],
        node_id: Annotated[StrictStr, Field(description="Node identifier (from list nodes response)")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_node_power_state_without_preload_content(
        self,
        fleet_id: Annotated[UUID, Field(description="Fleet identifier")],
        node_id: Annotated[StrictStr, Field(description="Node identifier (from list nodes response)")],
        _request_timeout: Union[
    ...
    def _get_node_power_state_serialize(
        self,
        fleet_id,
        node_id,
        _request_auth,
