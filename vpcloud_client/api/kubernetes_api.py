...
class KubernetesApi:
    ...
    def cordon_customer_mks2_worker_node(
        ...
        node_id: Annotated[StrictStr, Field(description="Managed Kubernetes worker-node identifier (registry id)")],
        ...
        :type fleet_id: str
        :param node_id: Managed Kubernetes worker-node identifier (registry id) (required)
        :type node_id: str
