...
class KubernetesServiceLinks(BaseModel):
    """
    Links to Kubernetes cluster services
    """ # noqa: E501
    grafana: Optional[StrictStr] = Field(default=None, description="URL to the Grafana dashboard for cluster monitoring")
    __properties: ClassVar[List[str]] = ["grafana"]
