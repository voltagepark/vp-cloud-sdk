...
class Mks2PodList(BaseModel):
    ...
    """ # noqa: E501
    items: List[Mks2Pod] = Field(description="Pods in the current page. Empty array (not null) when the cluster has no matching pods.")
    meta: Optional[Mks2PodListMeta] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [Mks2Pod.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "meta": Mks2PodListMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
