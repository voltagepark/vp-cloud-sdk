...
class TestMks2PodContainerStatus(unittest.TestCase):
    """Mks2PodContainerStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Mks2PodContainerStatus:
        """Test Mks2PodContainerStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Mks2PodContainerStatus`
        """
        model = Mks2PodContainerStatus()
        if include_optional:
            return Mks2PodContainerStatus(
                name = '',
                ready = True,
                restart_count = 56,
                state = 'running',
    ...
    def testMks2PodContainerStatus(self):
        """Test Mks2PodContainerStatus"""
