...
class TestMks2PodListMeta(unittest.TestCase):
    """Mks2PodListMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Mks2PodListMeta:
        """Test Mks2PodListMeta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Mks2PodListMeta`
        """
        model = Mks2PodListMeta()
        if include_optional:
            return Mks2PodListMeta(
                next_cursor = ''
            )
        else:
            return Mks2PodListMeta(
