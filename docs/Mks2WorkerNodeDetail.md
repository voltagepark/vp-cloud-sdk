...
**gpu_validated** | **bool** | Whether managed Kubernetes has run GPU validation against this node and it passed. Convenience mirror of gpu.validated; absent when no GPU info is available. | [optional] 
**conditions** | [**List[Mks2NodeCondition]**](Mks2NodeCondition.md) | Node conditions passed through from the tenant Kubernetes node, including custom node conditions. Absent until the node has joined. | [optional] 
**gpu** | [**Mks2GpuInfo**](Mks2GpuInfo.md) |  | [optional] 
**registered_at** | **datetime** | When the node was added to the managed Kubernetes worker registry. | [optional] 
