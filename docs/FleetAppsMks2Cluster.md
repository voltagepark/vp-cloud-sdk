...
------------ | ------------- | ------------- | -------------
**cluster_id** | **str** | Managed Kubernetes cluster ID (stable across enrichment results) | 
**cluster_name** | **str** | Managed Kubernetes cluster name as reported by managed Kubernetes | 
**kubernetes_version** | **str** | Kubernetes version running on the cluster (e.g. v1.35.0) | 
**cluster_status** | **str** | Live cluster status reported by managed Kubernetes (lowercase). | 
...
**created_at** | **datetime** | Timestamp when the managed Kubernetes cluster was created | 
