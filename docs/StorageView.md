...
The API's typed view of a single physical VAST storage view (a mount point and its quotas). Sizes are in bytes; the storage backend wire format is not exposed to callers.
